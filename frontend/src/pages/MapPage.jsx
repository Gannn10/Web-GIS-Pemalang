...
const MapPage = () => {
    ...
    return (
        <div className="flex flex-col h-[100dvh] w-full overflow-hidden bg-gray-100 font-sans relative">
                        ...
                        <div className="mt-2 mb-2 px-1">
                            <div className="relative bg-gradient-to-br from-[#E6F0FF] to-[#D6E6FE] rounded-[20px] overflow-hidden shadow-[0_4px_20px_rgba(46,130,247,0.15)] border border-white/50 p-5">
                                ...
                                <div className="relative z-10 w-[70%]">
                                    ...
                                    <p className="text-[9px] text-[#475569] font-medium leading-relaxed mb-1">Temukan berbagai wisata menarik di Kabupaten Pemalang</p>
                                </div>
            ...
            <AnimatePresence>
                {(isLocationMenuOpen && !isSidebarOpen) && (
                    <motion.div
